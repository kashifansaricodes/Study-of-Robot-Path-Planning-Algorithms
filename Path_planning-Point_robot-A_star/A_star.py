...
cv2.rectangle(map, pt1=(100 - clearance, 0), pt2=(175 + clearance, 400 + clearance), color=(0, 0, 255), thickness=-1)
cv2.rectangle(map, pt1=(275 - clearance, 100 - clearance), pt2=((350 + clearance), 500), color=(0, 0, 255), thickness=-1)
...
cv2.rectangle(map, pt1=(900 - clearance, 50 - clearance), pt2=(1100 + clearance, 125 + clearance), color=(0, 0, 255), thickness=-1)
cv2.rectangle(map, pt1=((1020 - clearance), (125 + clearance)), pt2=((1100 + clearance), (425)), color=(0, 0, 255), thickness=-1)
cv2.rectangle(map, pt1=((900 - clearance), (375 - clearance)), pt2=((1100 + clearance), (450 + clearance)), color=(0, 0, 255), thickness=-1)
...
while True:
    ...
    if np.array_equal(start_pixel_value, red) or np.array_equal(start_pixel_value, blue) or ((clearance + robot_radius) >= start_x >= (map.shape[0]-(clearance + robot_radius))) or ((clearance + robot_radius) >= start_y < (map.shape[1]-(clearance + robot_radius))):
...
while True:
    ...
    theta_g = int(input("Enter goal theta value: "))
...
goal_node = (goal_y, goal_x, theta_g)
...
if path:
    ...
    cv2.circle(map, (start_x, start_y), 5, (0, 100, 100), -1)  # Green circle for initial position
    cv2.circle(map, (goal_x, goal_y), 5, (0, 0, 255), -1)   # Red circle for goal position
